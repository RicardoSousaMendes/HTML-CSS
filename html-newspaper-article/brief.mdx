...
A boa utilização dos elementos certos permite ao browser entender questões de acessibilidade. Uma <div> não é um texto. um <p> não é uma imagem. Esta lógica permite ao browser entender
